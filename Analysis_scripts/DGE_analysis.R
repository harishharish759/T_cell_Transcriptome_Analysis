...
#load the raw counts files (created using the script 'raw counts files with HGNC symbol.R' )
...
#write results of DGE analysis for selected two time points and save as text file
# you can adjust the timepoints to compare here, i.e. Time_t2_vs_t1, Time_t3_vs_t1, etc
